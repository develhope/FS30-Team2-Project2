export const ReviewsList = [
  {
    ...
    starNumber: 5,
    reviewIt:
      "Un'esperienza indimenticabile! Il viaggio è stato perfetto, tutto organizzato nei minimi dettagli. Le guide turistiche erano molto preparate e simpatiche. Lo consiglio a tutti!",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "Il viaggio è stato molto bello, anche se alcuni luoghi erano un po' troppo affollati. Tuttavia, l'organizzazione è stata buona e le attività molto divertenti.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 3,
    reviewIt:
      "La qualità del servizio non era all'altezza delle aspettative. Alcuni luoghi erano magnifici, ma altri non erano ben gestiti.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Un viaggio fantastico! La natura era mozzafiato e la guida ci ha raccontato tante storie interessanti. Da rifare sicuramente!",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "L'evento è stato molto interessante, anche se un po' troppo lungo. Mi è piaciuto comunque molto e ho imparato molte cose nuove.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 2,
    reviewIt:
      "Purtroppo l'esperienza non è stata positiva. I trasporti erano ritardati e alcune attività non sono state rispettate.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Tutto perfetto, dalla partenza all'arrivo. I posti che abbiamo visitato erano spettacolari e l'atmosfera era fantastica.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "Molto bello, ma qualche piccola imperfezione. Un paio di escursioni non erano all'altezza delle aspettative, ma nel complesso è stato un bel viaggio.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 3,
    reviewIt:
      "L'esperienza è stata buona, ma non eccellente. Alcuni posti erano troppo turistici e ho preferito quelli più tranquilli.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Un sogno che si avvera! Ogni angolo era spettacolare, e le persone che ho incontrato durante il viaggio erano tutte eccezionali.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "L'evento è stato davvero emozionante. Solo un piccolo problema con l'organizzazione, ma nulla che abbia rovinato l'esperienza generale.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Viaggio da sogno! La vista era incredibile e le attività sono state organizzate in modo impeccabile. Consigliatissimo!",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 3,
    reviewIt:
      "Esperienza buona ma niente di eccezionale. Alcuni momenti sono stati un po' noiosi e la guida non sempre riusciva a coinvolgere il gruppo.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "Bella esperienza, anche se ci aspettavamo un po' di più dalla qualità dei pasti. Ma per il resto tutto perfetto!",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Un'esperienza unica, da ripetere! La destinazione era incantevole e ogni attività era pensata per farci vivere un'esperienza autentica.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 2,
    reviewIt:
      "Non è stato quello che ci aspettavamo. La qualità dei servizi era scarsa e il programma non era ben strutturato.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Una giornata indimenticabile! L'evento è stato perfetto, con tante attività coinvolgenti. Non vedo l'ora di partecipare di nuovo!",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 4,
    reviewIt:
      "Il viaggio è stato molto bello, ma ho trovato che alcuni luoghi fossero troppo affollati. Comunque, è stato un buon modo per scoprire la cultura locale.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 3,
    reviewIt:
      "Sufficiente, ma ci aspettavamo di più. Alcune escursioni non sono state all'altezza e l'alloggio non era molto confortevole.",
    reviewEng:
  ...
  },
  {
    ...
    starNumber: 5,
    reviewIt:
      "Tutto perfetto! L'atmosfera era unica e ogni dettaglio era curato alla perfezione. Un'esperienza che non dimenticherò mai.",
    reviewEng:
